...
import ru.suborg.javaspring06.models.exceptions.ExceptionBody;
import ru.suborg.javaspring06.models.exceptions.ResourceNotFoundException;
...
public class AdviceController {
    ...
    public ExceptionBody badCase(Exception e){
        ExceptionBody exceptionBody = new ExceptionBody();
        exceptionBody.setMessage("Шеф, все пропало, сервер умер!");
        exceptionBody.setLocalDateTime(LocalDateTime.now());
        return exceptionBody;
    }
